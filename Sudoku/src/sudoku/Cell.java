...
public class Cell extends JTextField {
   ...
   public static final Color BG_CORRECT_GUESS = new Color(152, 252, 209);
   ...
   //DARK MODE 
   public static final Color DBG_GIVEN = new Color(0, 0, 0); // 
   public static final Color DFG_GIVEN = Color.WHITE;
   public static final Color DFG_NOT_GIVEN = Color.BLACK;
   public static final Color DBG_TO_GUESS  = Color.YELLOW;
   public static final Color DBG_CORRECT_GUESS = new Color(152, 252, 209);
   public static final Color DBG_WRONG_GUESS   = new Color(255, 153, 153);
